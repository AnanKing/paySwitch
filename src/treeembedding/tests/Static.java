...
import treeembedding.credit.CreditMaxFlow2;
...
//        String transList = path + "finalSets/static/jan2013-trans-lcc-noself-uniq-1M0-4-back2.txt";
//        String graph = path + "finalSets/static/jan2013-lcc-t0-4.graph";
        ...
        if (config == 10) {
            // max flow
            CreditMaxFlow2 m = new CreditMaxFlow2(transList, name, tl, tries, up,
                    epoch);
