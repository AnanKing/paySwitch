...
//失败链路大于N后进行调用
public class CreditMaxFlow4 extends Metric {
    // input parameters
...
//	double[] failThroughput = new double[100000 / stepCount];
    ...
    public CreditMaxFlow4(String file, String name, double requeueInt,
    ...
    public CreditMaxFlow4(String file, String name, double requeueInt, int max,
    ...
    public CreditMaxFlow4(String file, String name, double requeueInt, int max, double epoch) {
    ...
    private int[] fordFulkerson(Transaction cur, Graph g, Node[] nodes, boolean[] exclude) {
        ...
        while (totalflow < cur.val && (resp = findResidualFlow(edgeweights, g.getNodes(), src, dest)).length > 1) {
            ...
            for (int i = 0; i < respath.length - 1; i++) {
                ...
                // call Switch payment
                if ((cur.val - a) > edgeFailCount) { // add by @anan start
