...
//链路差值大于N后进行调用
public class CreditFlare4 extends Metric {
    //input parameters
    ...
    public CreditFlare4(String file, String name, int rn, int k, int nb, int ntab,
    ...
    private int[] route(Transaction cur, Graph g, Node[] nodes, boolean[] exclude) {
        ...
        for (int j = 0; j < paths.size(); j++) {
            ...
            for (int i = 1; i < p.length; i++) {
                ...
                // call switch payment edgeFailCount
                if ((cur.val - w) > edgeFailCount) {
