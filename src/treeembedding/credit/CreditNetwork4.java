...
//失败链路达到10*N后进行调用
public class CreditNetwork4 extends Metric {
    // input parameters
    ...
    int edgeFailCount;
    Map<Edge, Long> routeFailCount = new HashMap<>();
    ...
    public CreditNetwork4(String file, String name, double epoch, Treeroute ra, boolean dynRep,
    ...
    public CreditNetwork4(String file, String name, double epoch, Treeroute ra, boolean dynRep,
                          ...
                          Partitioner part, int[] roots, int max, String links, boolean up, int edgeFailCount) {
        super("CREDIT_NETWORK", new Parameter[]{new StringParameter("NAME", name), new DoubleParameter("EPOCH", epoch),
                new StringParameter("RA", ra.getKey()), new BooleanParameter("DYN_REPAIR", dynRep),
                new BooleanParameter("MULTI", multi), new IntParameter("TREES", roots.length),
                new DoubleParameter("REQUEUE_INTERVAL", requeueInt), new StringParameter("PARTITIONER", part.getName()),
        ...
        this.update = up;
        this.edgeFailCount = edgeFailCount;
    }

    public CreditNetwork4(String file, String name, double epoch, Treeroute ra, boolean dynRep,
                          boolean multi, boolean shortest, boolean disjoint, double requeueInt,
                          Partitioner part, int[] roots, int max, String links, int edgeFailCount) {
        this(file, name, epoch, ra, dynRep, multi, shortest, disjoint, requeueInt, part, roots, max, links, true, edgeFailCount);// up is true is changed to false by anan.
    }
...
//				failThroughput[failCount / stepCount - 1 ] = SuccessAmount / PaymentAmount;
//			}
...
//                paths[j] = this.ra.getRoute(s, d, j, g, nodes, exclude, edgeweights, vals[j], edgeFailCount, routeFailCount);
