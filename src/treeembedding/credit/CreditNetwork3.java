...
import treeembedding.other.ModiGraph;
import treeembedding.other.OthersAlgorithm;
...
//每隔stepcount条交易调用一次的
public class CreditNetwork3 extends Metric {
    // input parameters
    double epoch; // interval for stabilization overhead (=epoch between spanning tree
    // recomputations if !dynRepair)
    Vector<Transaction> transactions; // vector of transactions, sorted by time
    Treeroute ra; // routing algorithm
    boolean dynRepair; // true if topology changes are immediately fixed rather than recomputation each
    // epoch
    boolean multi; // using multi-party computation to determine minimum or do routing adhoc
    boolean shortest;//using shortest ptah to determine routing
    boolean disjoint;//using find two disjoint the path to determine routing
    ...
    double SuccessCountAgain = 0;
    double SuccessAmountAgain = 0;
    double PaymentAmountAgain = 0;

    List SuccessAmountList = new ArrayList<>();
    List SuccessCountList = new ArrayList<>();
    List PaymentAmountList = new ArrayList<>();

    List SuccessAmountAgainList = new ArrayList<>();
    List SuccessCountAgainList = new ArrayList<>();
    List PaymentAmountAgainList = new ArrayList<>();
    ...
    Distribution transactionMessRe; // distribution of #messages needed, counting re-transactions as part of
    // transaction
    ...
    boolean log = false;
    String routeSuccPath = "./data/Results/jan2013-lcc-t0-SM-routeSucc-root1-dyn-1-SP-E8-All.txt";
    String paySuccPath = "./data/Results/jan2013-lcc-t0-SM-paySucc-root1-dyn-1-SP-E8-All.txt";
    String edgeWeightPath = "./data/Results/jan2013-lcc-t0-SM-finished-transactions-Weight-root1-dyn-1-SP-E8-All.txt";
    String routeFailPath = "./data/Results/jan2013-lcc-t0-SM-routeFail-root1-dyn-1-SPE8-All.txt";
    // this path used for 0 7 0 (SpeedyMurmur) to record the transaction path
//	String routeSuccPath = "D:\\code\\speedy-code-SP\\speedy\\data\\Results\\jan2013-lcc-t0-SM-routeSucc-root1-dyn-9-SP-3-E8.txt";
//	String paySuccPath = "D:\\code\\speedy-code-SP\\speedy\\data\\Results\\jan2013-lcc-t0-SM-paySucc-root1-dyn-9-SP-3-E8.txt";
//	String edgeWeightPath = "D:\\code\\speedy-code-SP\\speedy\\data\\Results\\jan2013-lcc-t0-SM-finished-transactions-Weight-root1-dyn-9-SP-3-E8.txt";
//	String routeSuccPath = "D:\\code\\speedy-code-SP\\speedy\\data\\Results\\jan2013-lcc-t0-SM-routeSucc-root1-dyn-1-NoSP-3-E8.txt";
//	String paySuccPath = "D:\\code\\speedy-code-SP\\speedy\\data\\Results\\jan2013-lcc-t0-SM-paySucc-root1-dyn-1-NoSP-3-E8.txt";
//	String edgeWeightPath = "D:\\code\\speedy-code-SP\\speedy\\data\\Results\\jan2013-lcc-t0-SM-finished-transactions-Weight-root1-dyn-1-NoSP-3-E8.txt";

    // this path used for 0 0 0 (SilentWhispers) to record the transaction path
//    String routeSuccPath = "D:\\code\\PaySwitch\\data\\Results\\jan2013-lcc-t0-SW-routeSucc-root1-dyn-1-SP-3-E8.txt";
//    String paySuccPath = "D:\\code\\PaySwitch\\data\\Results\\jan2013-lcc-t0-SW-paySucc-root1-dyn-1-SP-3-E8.txt";
//    String edgeWeightPath = "D:\\code\\PaySwitch\\data\\Results\\jan2013-lcc-t0-SW-finished-transactions-Weight-root1-dyn-1-SP-3-E8.txt";
//    String routeFailPath = "D:\\code\\PaySwitch\\data\\Results\\jan2013-lcc-t0-SW-routeFail-root1-dyn-1-SP-3-E8.txt";
//	String routeSuccPath = "D:\\code\\speedy-code-SP\\speedy\\data\\Results\\jan2013-lcc-t0-SW-routeSucc-root1-dyn-1-NoSP-E8.txt";
//	String paySuccPath = "D:\\code\\speedy-code-SP\\speedy\\data\\Results\\jan2013-lcc-t0-SW-paySucc-root1-dyn-1-NoSP-E8.txt";
//	String edgeWeightPath = "D:\\code\\speedy-code-SP\\speedy\\data\\Results\\jan2013-lcc-t0-SW-finished-transactions-Weight-root1-dyn-1-NoSP-E8.txt";
//	String routeFailPath = "D:\\code\\speedy-code-SP\\speedy\\data\\Results\\jan2013-lcc-t0-SW-routeFail-root1-dyn-1-NoSP-E8.txt";
//	String routeSuccPath = "D:\\code\\speedy-code-SP\\speedy\\data\\Results\\jan2013-lcc-t0-SS-routeSucc-root1-dyn-1-NoSP.txt";
//	String paySuccPath = "D:\\code\\speedy-code-SP\\speedy\\data\\Results\\jan2013-lcc-t0-SS-paySucc-root1-dyn-1-NoSP.txt";
//	String edgeWeightPath = "D:\\code\\speedy-code-SP\\speedy\\data\\Results\\jan2013-lcc-t0-SS-finished-transactions-Weight-root1-dyn-1-NoSP.txt";
//	String routeFailPath = "D:\\code\\speedy-code-SP\\speedy\\data\\Results\\jan2013-lcc-t0-SS-routeFail-root1-dyn-1-NoSP.txt";
//	String routeSuccPath = "D:\\code\\speedy-code-SP\\speedy\\data\\Results\\jan2013-lcc-t0-DS-routeSucc-root1-dyn-1-NoSP.txt";
//	String paySuccPath = "D:\\code\\speedy-code-SP\\speedy\\data\\Results\\jan2013-lcc-t0-DS-paySucc-root1-dyn-1-NoSP.txt";
//	String edgeWeightPath = "D:\\code\\speedy-code-SP\\speedy\\data\\Results\\jan2013-lcc-t0-DS-finished-transactions-Weight-root1-dyn-1-NoSP.txt";
//	String routeFailPath = "D:\\code\\speedy-code-SP\\speedy\\data\\Results\\jan2013-lcc-t0-DS-routeFail-root1-dyn-1-NoSP.txt";

    Map<Edge, Long> routeSucc = new HashMap<>();
    Map<Edge, Long> paySucc = new HashMap<>();
    Map<Edge, Long> routeFail = new HashMap<>();

    public CreditNetwork3(String file, String name, double epoch, Treeroute ra, boolean dynRep,
                          boolean multi, double requeueInt, Partitioner part, int[] roots, int max, String links, boolean up) {
        super("CREDIT_NETWORK",
                new Parameter[]{new StringParameter("NAME", name), new DoubleParameter("EPOCH", epoch),
    ...
    //add by @anan
    public CreditNetwork3(String file, String name, double epoch, Treeroute ra, boolean dynRep,
                          boolean multi, boolean shortest, double requeueInt, Partitioner part, int[] roots, int max, String links, boolean up) {
    ...
    public CreditNetwork3(String file, String name, double epoch, Treeroute ra, boolean dynRep,
                          boolean multi, boolean shortest, double requeueInt, Partitioner part, int[] roots, int max, String links) {
        this(file, name, epoch, ra, dynRep, multi, shortest, requeueInt, part, roots, max, links, true);// up is true is changed to false by anan.
        // up is true that means not update the weights and change weights with transfer. Dynamic
        // up is false that means update the weights and not change weights withe transfer.  Static. reset to original state evey time
    }

    public CreditNetwork3(String file, String name, double epoch, Treeroute ra, boolean dynRep,
                          boolean multi, boolean shortest, boolean disjoint, double requeueInt, Partitioner part, int[] roots, int max, String links, boolean up) {
        super("CREDIT_NETWORK", new Parameter[]{new StringParameter("NAME", name), new DoubleParameter("EPOCH", epoch),
                new StringParameter("RA", ra.getKey()), new BooleanParameter("DYN_REPAIR", dynRep),
                new BooleanParameter("MULTI", multi), new IntParameter("TREES", roots.length),
                new DoubleParameter("REQUEUE_INTERVAL", requeueInt), new StringParameter("PARTITIONER", part.getName()),
    ...
    public CreditNetwork3(String file, String name, double epoch, Treeroute ra, boolean dynRep,
                          boolean multi, boolean shortest, boolean disjoint, double requeueInt, Partitioner part, int[] roots, int max, String links) {
        this(file, name, epoch, ra, dynRep, multi, shortest, disjoint, requeueInt, part, roots, max, links, true);// up is true is changed to false by anan.
        // up is true that means not update the weights and change weights with transfer. Dynamic
        // up is false that means update the weights and not change weights withe transfer.  Static. reset to original state evey time
    }

    public CreditNetwork3(String file, String name, double epoch, Treeroute ra, boolean dynRep,
                          boolean multi, boolean shortest, boolean disjoint, double requeueInt,
                          Partitioner part, int[] roots, int max, String links, boolean up, int stepCount) {
        super("CREDIT_NETWORK", new Parameter[]{new StringParameter("NAME", name), new DoubleParameter("EPOCH", epoch),
                new StringParameter("RA", ra.getKey()), new BooleanParameter("DYN_REPAIR", dynRep),
                new BooleanParameter("MULTI", multi), new IntParameter("TREES", roots.length),
                new DoubleParameter("REQUEUE_INTERVAL", requeueInt), new StringParameter("PARTITIONER", part.getName()),
    ...
    public CreditNetwork3(String file, String name, double epoch, Treeroute ra, boolean dynRep,
                          boolean multi, boolean shortest, boolean disjoint, double requeueInt,
                          Partitioner part, int[] roots, int max, String links, int stepCount) {
        this(file, name, epoch, ra, dynRep, multi, shortest, disjoint, requeueInt, part, roots, max, links, true, stepCount);// up is true is changed to false by anan.
    }
    ...
    public void computeData(Graph g, Network n, HashMap<String, Metric> m) {
        ...
        Treeembedding embed = new Treeembedding("T", 60, roots, Direct.TWOPHASE);
        ...
        LinkedList<Transaction> failTrans = new LinkedList<Transaction>();
        int epoch_old = 0;
        int epoch_cur = 0;
        int cur_stab = 0;
        int c = 0;
        double cur_succ = 0;
        int cur_count = 0;
        Random rand = new Random(1);// Modify by Anan which aims to generate the same random sequence
        CreditLinks edgeweights = (CreditLinks) g.getProperty("CREDIT_LINKS");
        while (c < this.transactions.size() || toRetry.size() > 0) {
            // 0: decide which is next transaction: previous one or new one? and add new
            // links if any
            ...
            System.out.println("The current transaction number is: " + count);
            // }

            // 1: check if and how many spanning tree re-construction took place since last
            // transaction
            ...
            if (this.multi) {
                results = this.routeMulti(cur, g, nodes, exclude, edgeweights, false);
            } else if (this.shortest) {
                results = this.routeShortPath(cur, g, nodes, exclude, edgeweights, false);
            } else if (this.disjoint) {
                results = this.routeDisjointPath(cur, g, nodes, exclude, edgeweights, false);
            } else {
                results = this.routeAdhoc(cur, g, nodes, exclude, edgeweights, false);
            }
            ...
            PaymentAmount += cur.val;
            if (count % stepCount == 0) {
                SuccessAmountList.add(SuccessAmount);
                PaymentAmountList.add(PaymentAmount);
                SuccessCountList.add(SuccessCount);
            }
            if (c == 5000) {
                this.flag1 = this.success;
                this.throughput1 = this.SuccessAmount / this.PaymentAmount;
            }
            if (c == 10000) {
                this.flag2 = this.success;
                this.throughput2 = this.SuccessAmount / this.PaymentAmount;
            }
            if (c == 15000) {
                this.flag3 = this.success;
                this.throughput3 = this.SuccessAmount / this.PaymentAmount;
            }
            if (c == 20000) {
                this.flag4 = this.success;
                this.throughput4 = this.SuccessAmount / this.PaymentAmount;
            }
            if (c == 25000) {
                this.flag5 = this.success;
                this.throughput5 = this.SuccessAmount / this.PaymentAmount;
            }
            if (c == 30000) {
                this.flag6 = this.success;
                this.throughput6 = this.SuccessAmount / this.PaymentAmount;
            }
            if (c == 35000) {
                this.flag7 = this.success;
                this.throughput7 = this.SuccessAmount / this.PaymentAmount;
            }
            if (c == 40000) {
                this.flag8 = this.success;
                this.throughput8 = this.SuccessAmount / this.PaymentAmount;
            }
            if (c == 45000) {
                this.flag9 = this.success;
                this.throughput9 = this.SuccessAmount / this.PaymentAmount;
            }
            if (c == 50000) {
                this.flag10 = this.success;
                this.throughput10 = this.SuccessAmount / this.PaymentAmount;
            }
            if (c == 55000) {
                this.flag11 = this.success;
                this.throughput11 = this.SuccessAmount / this.PaymentAmount;
            }
            if (c == 60000) {
                this.flag12 = this.success;
                this.throughput12 = this.SuccessAmount / this.PaymentAmount;
            }
            if (c == 65000) {
                this.flag13 = this.success;
                this.throughput13 = this.SuccessAmount / this.PaymentAmount;
            }
            if (c == 70000) {
                this.flag14 = this.success;
                this.throughput14 = this.SuccessAmount / this.PaymentAmount;
            }
            if (c == 75000) {
                this.flag15 = this.success;
                this.throughput15 = this.SuccessAmount / this.PaymentAmount;
            }
            if (c == 80000) {
                this.flag16 = this.success;
                this.throughput16 = this.SuccessAmount / this.PaymentAmount;
            }
            if (c == 85000) {
                this.flag17 = this.success;
                this.throughput17 = this.SuccessAmount / this.PaymentAmount;
            }
            if (c == 90000) {
                this.flag18 = this.success;
                this.throughput18 = this.SuccessAmount / this.PaymentAmount;
            }
            if (c == 95000) {
                this.flag19 = this.success;
                this.throughput19 = this.SuccessAmount / this.PaymentAmount;
            }
            if (c == 100000) {
                this.flag20 = this.success;
                this.throughput20 = this.SuccessAmount / this.PaymentAmount;
            }
...
//                    int[] results;
                    originalWeight = new HashMap<Edge, Double>();
                    if (this.multi) {
                        results = this.routeMulti(cur, g, nodes, exclude, edgeweights, true);
                    } else if (this.shortest) {
                        results = this.routeShortPath(cur, g, nodes, exclude, edgeweights, true);
                    } else if (this.disjoint) {
                        results = this.routeDisjointPath(cur, g, nodes, exclude, edgeweights, true);
                    } else {
                        results = this.routeAdhoc(cur, g, nodes, exclude, edgeweights, true);
                    }
...
//
                    ...
                    PaymentAmountAgain += cur.val;

                    if (failCount % stepCount == 0) {
                        SuccessAmountAgainList.add(SuccessAmountAgain);
                        SuccessCountAgainList.add(SuccessCountAgain);
                        PaymentAmountAgainList.add(PaymentAmountAgain);
                    }
        ...
        WriteToTxt.writeEdgeToTxt(routeSuccPath, routeSucc);
        WriteToTxt.writeEdgeToTxt(paySuccPath, paySucc);
        //WriteToTxt.writeEdgeToTxt(routeFailPath, routeFail);

        Set<Entry<Edge, double[]>> weights = edgeweights.getWeights();
        String[] s = new String[weights.size()];
        int ind = 0;
        for (Entry<Edge, double[]> weight : weights) {
            Edge key = weight.getKey();
            double[] value = weight.getValue();
            String str = key.getSrc() + " " + key.getDst() + " " + value[0] + " " + value[1] + " " + value[2];
            // WriteToTxt.writeTxt(edgeWeightPath, s);
            s[ind] = str;
            ind++;
        }
        WriteToTxt.writeTxt(edgeWeightPath, s);
        ...
        this.flag1 = this.flag1 / 5000;
        this.flag2 = this.flag2 / 10000;
        this.flag3 = this.flag3 / 15000;
        this.flag4 = this.flag4 / 20000;
        this.flag5 = this.flag5 / 25000;
        this.flag6 = this.flag6 / 30000;
        this.flag7 = this.flag7 / 35000;
        this.flag8 = this.flag8 / 40000;
        this.flag9 = this.flag9 / 45000;
        this.flag10 = this.flag10 / 50000;
        this.flag11 = this.flag11 / 55000;
        this.flag12 = this.flag12 / 60000;
        this.flag13 = this.flag13 / 65000;
        this.flag14 = this.flag14 / 70000;
        this.flag15 = this.flag15 / 75000;
        this.flag16 = this.flag16 / 80000;
        this.flag17 = this.flag17 / 85000;
        this.flag18 = this.flag18 / 90000;
        this.flag19 = this.flag19 / 95000;
        this.flag20 = this.flag20 / 100000;
    ...
    private int repairTree(Node[] nodes, SpanningTree sp, TreeCoordinates coords, int subroot, CreditLinks ew) {
        ...
        Random rand = new Random(1);// Modify by Anan which aims to generate the same random sequence
        Direct[] dir = {Direct.BOTH, Direct.EITHER, Direct.NONE};
    ...
    private int addLink(int src, int dst, double weight, Graph g) {
        ...
        if (this.dynRepair) {
            ...
            // (TreeCoordinates)g.getProperty("TREE_COORDINATES_"+j);
            // st = st + this.repairTree(nodes, sp, coords, cut, (CreditLinks)
            // g.getProperty("CREDIT_LINKS"));
            // }
            // }
            // }
        }
     ...
     * i) finding path (one-way, but 3x path length as each neighbor needs to sign
     ...
     *
     * @return {success?0:-1, sum(pathlength), receiver-landmark,
     * landmarks-sender,overall message count, delay, p1, p2,...}
     */
    private int[] routeMulti(Transaction cur, Graph g, Node[] nodes, boolean[] exclude, CreditLinks edgeweights, boolean switchPay) {
        ...
        for (int j = 0; j < mins.length; j++) {
            ...
            if (paths[j][paths[j].length - 1] == dest) {
                ...
                while (i < paths[j].length) {
                    ...
                    // call for SwitchPayment
                    if (switchPay) {
                        if (cur.val > w) { // add by @Anan start
                            SwitchPayment.switchPayment(l, k, nodes, edgeweights, cur.val);
                        }
                        w = edgeweights.getPot(l, k);
                    }
                    // add by @Anan end
                    if (w < min) {
                        min = w;
                ...
                if (vals[j] > 0) {
                    ...
                    for (int i = 1; i < paths[j].length; i++) {
                        ...
                        if (!edgeweights.setWeight(l, k, vals[j])) {
                            ...
                            //if (log) {
                            System.out.println(
                                    "----Set weight of (" + l + "," + k + ") to " + edgeweights.getWeight(e)
                                            + "(previous " + w + ")");
                            //}
                        }
                        l = k;
        ...
        if (succ) {
            for (int j = 0; j < paths.length; j++) {
                for (int k = 0; k < paths[j].length - 1; k++) {
                    paySucc = edgeweights.getTimes(paths[j][k], paths[j][k + 1], paySucc);
                }
            }
        } else {
            for (int j = 0; j < paths.length; j++) {
                if (paths[j][paths[j].length - 1] == -1) {
                    for (int k = 0; k < paths[j].length - 2; k++) {
                        if (cur.val <= edgeweights.getPot(paths[j][k], paths[j][k + 1])) {
                            routeSucc = edgeweights.getTimes(paths[j][k], paths[j][k + 1], routeSucc);
                        } else {
                            routeFail = edgeweights.getTimes(paths[j][k], paths[j][k + 1], routeFail);
                        }
                    }
                } else {
                    for (int k = 0; k < paths[j].length - 1; k++) {
    ...
    private int[] routeShortPath(Transaction cur, Graph g, Node[] nodes, boolean[] exclude,
                                 CreditLinks edgeweights, boolean switchPay) {
        int[][] paths = new int[roots.length][];
        int src = cur.src;
        int dest = cur.dst;
        double vals = cur.val;
        ...
        this.zeroEdges = new Vector<Edge>();
        for (int j = 0; j < paths.length; j++) {
            paths[j] = OthersAlgorithm.getDijkstraPaths(g, src, dest);

            if (paths[j].length == 0) {
                succ = false;
                System.out.println("没有找到通路");
            } else {
                int l = paths[j][0];
                String path = ""; // add by me
                for (int i = 0; i < paths[j].length; i++) {
                    path = path + "->" + paths[j][i];
                }
                System.out.println(path);
                for (int i = 1; i < paths[j].length; i++) {
                    ...
                    if (switchPay) {
                        if (w < vals) {
                            SwitchPayment.switchPayment(l, k, nodes, edgeweights, vals);
                        }
                        w = edgeweights.getPot(l, k);
                    }
                    // end call
                ...
                if (succ) {
                    ...
                    for (int i = 1; i < paths[j].length; i++) {
                        ...
                        edgeweights.setWeight(l, k, vals);
                        if (log) {
    ...
    private int[] routeDisjointPath(Transaction cur, Graph g, Node[] nodes, boolean[] exclude,
                                    CreditLinks edgeweights, boolean switchPay) {
        int[][][] paths = new int[roots.length][][];
        int[][] respath = new int[roots.length][];
        int src = cur.src;
        int dest = cur.dst;
        double vals = cur.val;
        boolean succ1 = true;
        ...
        this.zeroEdges = new Vector<Edge>();
        for (int j = 0; j < paths.length; j++) {
            paths[j] = OthersAlgorithm.getDisjointPaths(ModiGraph.graphToModi(g), src, dest);

            if (paths[j][0][0] == src && paths[j][0][paths[j][0].length - 1] == dest) {
                System.out.println("first path");
                String path = "";
                for (int i = 0; i < paths[j][0].length; i++) {
                    path = path + "->" + paths[j][0][i];
                }
                System.out.println(path);
                int l = paths[j][0][0];
                for (int i = 1; i < paths[j][0].length; i++) {
                    int k = paths[j][0][i];
                    double w = edgeweights.getPot(l, k);
                    if (w < vals) {
                        succ1 = false;
            ...
            if (succ1) {
                ...
                if (paths[j][1].length == 0) {
                    succ2 = false;
                } else if (paths[j][1][0] == src && paths[j][1][paths[j][1].length - 1] == dest) {
                    System.out.println("second path");
                    String path = "";
                    for (int i = 0; i < paths[j][1].length; i++) {
                        path = path + "->" + paths[j][1][i];
                    }
                    System.out.println(path);
                    int l = paths[j][1][0];
                    for (int i = 1; i < paths[j][1].length; i++) {
                        int k = paths[j][1][i];
                        double w = edgeweights.getPot(l, k);
                        if (w < vals) {
                            succ2 = false;
        ...
        if (succ1) {
            for (int j = 0; j < paths.length; j++) {
                for (int k = 0; k < paths[j][0].length - 1; k++) {
                    paySucc = edgeweights.getTimes(paths[j][0][k], paths[j][0][k + 1], paySucc);
                }
            }
        } else {
            for (int j = 0; j < paths.length; j++) {
                if (paths[j][0].length > 1) {
                    for (int k = 0; k < paths[j][0].length - 1; k++) {
                        if (cur.val <= edgeweights.getPot(paths[j][0][k], paths[j][0][k + 1])) {
                            routeSucc = edgeweights.getTimes(paths[j][0][k], paths[j][0][k + 1], routeSucc);
                        } else {
                            routeFail = edgeweights.getTimes(paths[j][0][k], paths[j][0][k + 1], routeFail);
                        }
                    }
                }
            }
        ...
        for (int j = 0; j < paths.length; j++) {
            if (vals > 0) {
                if (paths[j][0][paths[j][0].length - 1] == dest) {
                    res[1] = res[1] + paths[j][0].length - 1;
                    res[6 + j] = paths[j][0].length - 1;
                } else {
                    res[1] = res[1] + paths[j][0].length - 2;
                    res[6 + j] = -(paths[j][0].length - 2);
                }
            }
        }
        //overall messages
        ...
        for (int j = 0; j < paths.length; j++) {
            if (vals > 0) {
                if (paths[j][0][paths[j][0].length - 1] == dest) {
                    if (paths[j][0].length > max) {
                        max = paths[j][0].length;
                    }
                } else {
                    if (paths[j][0].length - 1 > max) {
                        max = paths[j][0].length - 1;
                    }
                }
            }
        }
        ...
        this.setRoots(respath);
        return res;
    }

    private int[] routeAdhoc(Transaction cur, Graph g, Node[] nodes, boolean[] exclude, CreditLinks edgeweights, boolean switchPay) {
        int[][] paths = new int[roots.length][];
        int src = cur.src;
        int dest = cur.dst;
...
//                paths[j] = this.ra.getRoute(s, d, j, g, nodes, exclude, edgeweights, vals[j], switchPay);

                String path = ""; // start add by me
                for (int i = 0; i < paths[j].length; i++) {
                    path = path + "->" + paths[j][i];
                }
        ...
        if (flag == 0) {
            for (int j = 0; j < paths.length; j++) {
                ...
                // WriteToTxt.writeTxt(paySuccessAllPath, path);
            }
        } else if (flag == 1) {
            for (int j = 0; j < paths.length; j++) {
                String path = "";
                if (paths[j][paths[j].length - 1] == -1) {
                    // go to treeroute.java to treck break links
                    // long depth = WriteToTxt.readDepth(paths[j][paths[j].length - 2]);
                    // edgeweights.getDepths();
                    // System.out.println("The depth of " + paths[j][paths[j].length - 2] + " is:" +
                    // depth);
                    for (int k = 0; k < paths[j].length - 2; k++) {
                        path = path + "->" + paths[j][k];
                        routeSucc = edgeweights.getTimes(paths[j][k], paths[j][k + 1], routeSucc);
                    }
                    // WriteToTxt.writeTxt(routeFailureAllPath, path);
                } else {
                    for (int k = 0; k < paths[j].length - 1; k++) {
                        path = path + "->" + paths[j][k];
                        routeSucc = edgeweights.getTimes(paths[j][k], paths[j][k + 1], routeSucc);
                    }
                    // WriteToTxt.writeTxt(routeSuccessAllPath, path);
                }
            }
        }
    ...
    public Single[] getSingles() {
        ...
        Single sf1 = new Single("FLAG_SUCCESS_0_5000", this.flag1);
        Single sf2 = new Single("FLAG_SUCCESS_0_10000", this.flag2);
        Single sf3 = new Single("FLAG_SUCCESS_0_15000", this.flag3);
        Single sf4 = new Single("FLAG_SUCCESS_0_20000", this.flag4);
        Single sf5 = new Single("FLAG_SUCCESS_0_25000", this.flag5);
        Single sf6 = new Single("FLAG_SUCCESS_0_30000", this.flag6);
        Single sf7 = new Single("FLAG_SUCCESS_0_35000", this.flag7);
        Single sf8 = new Single("FLAG_SUCCESS_0_40000", this.flag8);
        Single sf9 = new Single("FLAG_SUCCESS_0_45000", this.flag9);
        Single sf10 = new Single("FLAG_SUCCESS_0_50000", this.flag10);
        Single sf11 = new Single("FLAG_SUCCESS_0_55000", this.flag11);
        Single sf12 = new Single("FLAG_SUCCESS_0_60000", this.flag12);
        Single sf13 = new Single("FLAG_SUCCESS_0_65000", this.flag13);
        Single sf14 = new Single("FLAG_SUCCESS_0_70000", this.flag14);
        Single sf15 = new Single("FLAG_SUCCESS_0_75000", this.flag15);
        Single sf16 = new Single("FLAG_SUCCESS_0_80000", this.flag16);
        Single sf17 = new Single("FLAG_SUCCESS_0_85000", this.flag17);
        Single sf18 = new Single("FLAG_SUCCESS_0_90000", this.flag18);
        Single sf19 = new Single("FLAG_SUCCESS_0_95000", this.flag19);
        Single sf20 = new Single("FLAG_SUCCESS_0_100000", this.flag20);

        Single tp1 = new Single("THROUGHPUT_0_5000", this.throughput1);
        Single tp2 = new Single("THROUGHPUT_0_10000", this.throughput2);
        Single tp3 = new Single("THROUGHPUT_0_15000", this.throughput3);
        Single tp4 = new Single("THROUGHPUT_0_20000", this.throughput4);
        Single tp5 = new Single("THROUGHPUT_0_25000", this.throughput5);
        Single tp6 = new Single("THROUGHPUT_0_30000", this.throughput6);
        Single tp7 = new Single("THROUGHPUT_0_35000", this.throughput7);
        Single tp8 = new Single("THROUGHPUT_0_40000", this.throughput8);
        Single tp9 = new Single("THROUGHPUT_0_45000", this.throughput9);
        Single tp10 = new Single("THROUGHPUT_0_50000", this.throughput10);
        Single tp11 = new Single("THROUGHPUT_0_55000", this.throughput11);
        Single tp12 = new Single("THROUGHPUT_0_60000", this.throughput12);
        Single tp13 = new Single("THROUGHPUT_0_65000", this.throughput13);
        Single tp14 = new Single("THROUGHPUT_0_70000", this.throughput14);
        Single tp15 = new Single("THROUGHPUT_0_75000", this.throughput15);
        Single tp16 = new Single("THROUGHPUT_0_80000", this.throughput16);
        Single tp17 = new Single("THROUGHPUT_0_85000", this.throughput17);
        Single tp18 = new Single("THROUGHPUT_0_90000", this.throughput18);
        Single tp19 = new Single("THROUGHPUT_0_95000", this.throughput19);
        Single tp20 = new Single("THROUGHPUT_0_100000", this.throughput20);
        ...
        Single SCL = new Single("SuccessCountList", 0L, ListToDouble(SuccessCountList));
        Single SAL = new Single("SuccessAmountList", 0L, ListToDouble(SuccessAmountList));
        Single PAL = new Single("PaymentAmountList", 0L, ListToDouble(PaymentAmountList));
        Single SCAL = new Single("SuccessCountAgainList", 0L, ListToDouble(SuccessCountAgainList));
        Single SAAL = new Single("SuccessAmountAgainList", 0L, ListToDouble(SuccessAmountAgainList));
        Single PAAL = new Single("PaymentAmountAgainList", 0L, ListToDouble(PaymentAmountAgainList));

        return new Single[]{m_av, m_Re_av, m_S_av, m_F_av, p_av, p_Re_av, p_S_av, p_F_av,
                reL_av, ls_av, s_av, s1, s, sf1, sf2, sf3, sf4, sf5, sf6, sf7, sf8, sf9, sf10,
                sf11, sf12, sf13, sf14, sf15, sf16, sf17, sf18, sf19, sf20, tp1, tp2, tp3, tp4, tp5, tp6, tp7,
                tp8, tp9, tp10, tp11, tp12, tp13, tp14, tp15, tp16, tp17, tp18, tp19, tp20,
                SCL, SAL, PAL, SCAL, SAAL, PAAL, pP_av, pPF_av, pPNF_av, rt, d1, d2, d3};
    }

    private static double[] ListToDouble(List list) {
        double[] doubleArray = new double[list.size()];
        for (int i = 0; i < list.size(); i++) {
            // 将对象转换为String，并将其解析为double类型
