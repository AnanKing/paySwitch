...
//先跑所有 再跑失败
public class CreditMaxFlow5 extends Metric {
    //input parameters
    ...
    //0 10 0(时时调用，不够就调)
    String routeSuccPath = "./data/Results/jan2013-lcc-t0-M-routeSucc-root1-dyn-PaySwitch3-E8AllNonull.txt";
    String paySuccPath = "./data/Results/jan2013-lcc-t0-M-paySucc-root1-dyn-PaySwitch3-E8AllNonull.txt";
    String edgeWeightPath = "./data/Results/jan2013-lcc-t0-M-finished-transactions-Weight-root1-dyn-PaySwitch3-E8AllNonull.txt";
    String routeFailPath = "./data/Results/jan2013-lcc-t0-M-routeFail-root1-dyn-PaySwitch3-E8AllNonull.txt";

    Map<Edge, Long> routeFail = new HashMap<>();
    Map<Edge, Long> routeSucc = new HashMap<>();
    Map<Edge, Long> paySucc = new HashMap<>();

    public CreditMaxFlow5(String file, String name, double requeueInt,
    ...
    public CreditMaxFlow5(String file, String name, double requeueInt, int max,
...
//                    toRetry.add(st, cur);
        ...
        while (failTrans.size() > 0) {
            ...
            //2: execute the transaction
            int[] results = this.fordFulkerson(cur, g, nodes, exclude, true);
            cur_count++;
            if (results[0] == 0) {
                cur_succ++;
                FailTimes++;// add by anan
