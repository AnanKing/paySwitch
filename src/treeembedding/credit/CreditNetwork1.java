...
//原始 +失败的混合
public class CreditNetwork1 extends Metric {
    // input parameters
...
//    String routeFailPathSW = "./data/Results/jan2013-lcc-t0-SW-routeFail-root1-dyn-PaySwitch3-E8AllNonull.txt";
    ...
    //0 0 0 (不调用)
    String routeSuccPathSW = "./data/Results/jan2013-lcc-t0-SW-routeSucc-root1-dyn-NoPaySwitch-E8AllNonull.txt";
    String paySuccPathSW = "./data/Results/jan2013-lcc-t0-SW-paySucc-root1-dyn-NoPaySwitch-E8AllNonull.txt";
    String edgeWeightPathSW = "./data/Results/jan2013-lcc-t0-SW-finished-transactions-Weight-root1-dyn-NoPaySwitch-E8AllNonull.txt";
    String routeFailPathSW = "./data/Results/jan2013-lcc-t0-SW-routeFail-root1-dyn-NoPaySwitch-E8AllNonull.txt";
...
//0 1 0(不调用)
    String routeSuccPathSS = "./data/Results/jan2013-lcc-t0-SS-routeSucc-root1-dyn-NoPaySwitch-E8AllNonull.txt";
    String paySuccPathSS = "./data/Results/jan2013-lcc-t0-SS-paySucc-root1-dyn-NoPaySwitch-E8AllNonull.txt";
    String edgeWeightPathSS = "./data/Results/jan2013-lcc-t0-SS-finished-transactions-Weight-root1-dyn-NoPaySwitch-E8AllNonull.txt";
    String routeFailPathSS = "./data/Results/jan2013-lcc-t0-SS-routeFail-root1-dyn-NoPaySwitch-E8AllNonull.txt";
...
//    0 2 0(不调用)
    String routeSuccPathDS = "./data/Results/jan2013-lcc-t0-DS-routeSucc-root1-dyn-NoPaySwitch-E8AllNonull.txt";
    String paySuccPathDS = "./data/Results/jan2013-lcc-t0-DS-paySucc-root1-dyn-NoPaySwitch-E8AllNonull.txt";
    String edgeWeightPathDS = "./data/Results/jan2013-lcc-t0-DS-finished-transactions-Weight-root1-dyn-NoPaySwitch-E8AllNonull.txt";
    String routeFailPathDS = "./data/Results/jan2013-lcc-t0-DS-routeFail-root1-dyn-NoPaySwitch-E8AllNonull.txt";
...
//0 7 0(不调用)
    String routeSuccPathSM = "./data/Results/jan2013-lcc-t0-SM-routeSucc-root1-dyn-NoPaySwitch-E8AllNonull.txt";
    String paySuccPathSM = "./data/Results/jan2013-lcc-t0-SM-paySucc-root1-dyn-NoPaySwitch-E8AllNonull.txt";
    String edgeWeightPathSM = "./data/Results/jan2013-lcc-t0-SM-finished-transactions-Weight-root1-dyn-NoPaySwitch-E8AllNonull.txt";
    String routeFailPathSM = "./data/Results/jan2013-lcc-t0-SM-routeFail-root1-dyn-NoPaySwitch-E8AllNonull.txt";

    Map<Edge, Long> routeSucc = new HashMap<>();
    Map<Edge, Long> paySucc = new HashMap<>();
    Map<Edge, Long> routeFail = new HashMap<>();

    public CreditNetwork1(String file, String name, double epoch, Treeroute ra, boolean dynRep,
...
//                    }
//                    w = edgeweights.getPot(l, k); // add by @Anan end
...
//                        w = edgeweights.getPot(l, k);
    ...
    public Single[] getSingles() {
        ...
        return new Single[]{m_av, m_Re_av, m_S_av, m_F_av, p_av, p_Re_av, p_S_av, p_F_av,
                reL_av, ls_av, s_av, s1, s, SCL, SAL, PAL, pP_av, pPF_av, pPNF_av, rt, d1, d2, d3};
    }
