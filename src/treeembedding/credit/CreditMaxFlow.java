...
//	double[] failThroughput = new double[100000 / stepCount];
    ...
    // this path used for 0 10 0 (SilentWhispers) to record the transaction path
//0 10 0(时时调用，不够就调)
    ...
    //0 10 0(不调用)
//    String routeSuccPath = "./data/Results/jan2013-lcc-t0-M-routeSucc-root1-dyn-NoPaySwitch-E8AllNonull.txt";
//    String paySuccPath = "./data/Results/jan2013-lcc-t0-M-paySucc-root1-dyn-NoPaySwitch-E8AllNonull.txt";
//    String edgeWeightPath = "./data/Results/jan2013-lcc-t0-M-finished-transactions-Weight-root1-dyn-NoPaySwitch-E8AllNonull.txt";
//    String routeFailPath = "./data/Results/jan2013-lcc-t0-M-routeFail-root1-dyn-NoPaySwitch-E8AllNonull.txt";
