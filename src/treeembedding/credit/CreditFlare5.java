...
////先跑所有 再跑失败
public class CreditFlare5 extends Metric {
    //input parameters
    ...
    //0 8 0(时时调用，不够就调)
    String routeSuccPath = "./data/Results/jan2013-lcc-t0-F-routeSucc-root1-dyn-PaySwitch3-E8AllNonull.txt";
    String paySuccPath = "./data/Results/jan2013-lcc-t0-F-paySucc-root1-dyn-PaySwitch3-E8AllNonull.txt";
    String edgeWeightPath = "./data/Results/jan2013-lcc-t0-F-finished-transactions-Weight-root1-dyn-PaySwitch3-E8AllNonull.txt";
    String routeFailPath = "./data/Results/jan2013-lcc-t0-F-routeFail-root1-dyn-PaySwitch3-E8AllNonull.txt";

    Map<Edge, Long> routeSucc = new HashMap<>();
    Map<Edge, Long> paySucc = new HashMap<>();
    Map<Edge, Long> routeFail = new HashMap<>();

    public CreditFlare5(String file, String name, int rn, int k, int nb, int ntab,
