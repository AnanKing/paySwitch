...
//先跑所有 再跑失败
public class CreditNetwork2 extends Metric {
    // input parameters
    ...
    boolean log = false;
    //    0 0 0 (时时调用，不够就调)
    String routeSuccPathSW = "./data/Results/jan2013-lcc-t0-SW-routeSucc-root1-dyn-PaySwitch3-E8AllNonull.txt";
    String paySuccPathSW = "./data/Results/jan2013-lcc-t0-SW-paySucc-root1-dyn-PaySwitch3-E8AllNonull.txt";
    String edgeWeightPathSW = "./data/Results/jan2013-lcc-t0-SW-finished-transactions-Weight-root1-dyn-PaySwitch3-E8AllNonull.txt";
    String routeFailPathSW = "./data/Results/jan2013-lcc-t0-SW-routeFail-root1-dyn-PaySwitch3-E8AllNonull.txt";

    //0 1 0(时时调用，不够就调)
    String routeSuccPathSS = "./data/Results/jan2013-lcc-t0-SS-routeSucc-root1-dyn-PaySwitch3-E8AllNonull.txt";
    String paySuccPathSS = "./data/Results/jan2013-lcc-t0-SS-paySucc-root1-dyn-PaySwitch3-E8AllNonull.txt";
    String edgeWeightPathSS = "./data/Results/jan2013-lcc-t0-SS-finished-transactions-Weight-root1-dyn-PaySwitch3-E8AllNonull.txt";
    String routeFailPathSS = "./data/Results/jan2013-lcc-t0-SS-routeFail-root1-dyn-PaySwitch3-E8AllNonull.txt";

    //    0 2 0(时时调用，不够就调)
    String routeSuccPathDS = "./data/Results/jan2013-lcc-t0-DS-routeSucc-root1-dyn-PaySwitch3-E8AllNonull.txt";
    String paySuccPathDS = "./data/Results/jan2013-lcc-t0-DS-paySucc-root1-dyn-PaySwitch3-E8AllNonull.txt";
    String edgeWeightPathDS = "./data/Results/jan2013-lcc-t0-DS-finished-transactions-Weight-root1-dyn-PaySwitch3-E8AllNonull.txt";
    String routeFailPathDS = "./data/Results/jan2013-lcc-t0-DS-routeFail-root1-dyn-PaySwitch3-E8AllNonull.txt";

    //    0 7 0(时时调用，不够就调)
    String routeSuccPathSM = "./data/Results/jan2013-lcc-t0-SM-routeSucc-root1-dyn-PaySwitch3-E8AllNonull.txt";
    String paySuccPathSM = "./data/Results/jan2013-lcc-t0-SM-paySucc-root1-dyn-PaySwitch3-E8AllNonull.txt";
    String edgeWeightPathSM = "./data/Results/jan2013-lcc-t0-SM-finished-transactions-Weight-root1-dyn-PaySwitch3-E8AllNonull.txt";
    String routeFailPathSM = "./data/Results/jan2013-lcc-t0-SM-routeFail-root1-dyn-PaySwitch3-E8AllNonull.txt";

    Map<Edge, Long> routeSucc = new HashMap<>();
    Map<Edge, Long> paySucc = new HashMap<>();
    Map<Edge, Long> routeFail = new HashMap<>();

    public CreditNetwork2(String file, String name, double epoch, Treeroute ra, boolean dynRep,
    ...
    public void computeData(Graph g, Network n, HashMap<String, Metric> m) {
        ...
        while (failTrans.size() > 0) {
            // 0: decide which is next transaction: previous one or new one? and add new
            Transaction cur = failTrans.poll();
            if (cur == null) {
                continue;
            }
            epoch_cur = (int) Math.floor(cur.time / epoch);
...
//
        ...
        if (this.multi) {
            WriteToTxt.writeEdgeToTxt(routeSuccPathSW, routeSucc);
            WriteToTxt.writeEdgeToTxt(paySuccPathSW, paySucc);
            WriteToTxt.writeEdgeToTxt(routeFailPathSW, routeFail);
            WriteToTxt.writeTxt(edgeWeightPathSW, s);
        } else if (this.shortest) {
            WriteToTxt.writeEdgeToTxt(routeSuccPathSS, routeSucc);
            WriteToTxt.writeEdgeToTxt(paySuccPathSS, paySucc);
            WriteToTxt.writeEdgeToTxt(routeFailPathSS, routeFail);
            WriteToTxt.writeTxt(edgeWeightPathSS, s);
        } else if (this.disjoint) {
            WriteToTxt.writeEdgeToTxt(routeSuccPathDS, routeSucc);
            WriteToTxt.writeEdgeToTxt(paySuccPathDS, paySucc);
            WriteToTxt.writeEdgeToTxt(routeFailPathDS, routeFail);
            WriteToTxt.writeTxt(edgeWeightPathDS, s);
        } else {
            WriteToTxt.writeEdgeToTxt(routeSuccPathSM, routeSucc);
            WriteToTxt.writeEdgeToTxt(paySuccPathSM, paySucc);
            WriteToTxt.writeEdgeToTxt(routeFailPathSM, routeFail);
            WriteToTxt.writeTxt(edgeWeightPathSM, s);
        }
